/**
 * Shared color utilities for the first-egg hatching ceremony background.
 *
 * Adapted from Ditto's onboarding/lib/ceremony-colors.ts (pure, zero-dependency
 * logic) so the Island reveal background derives the same soft pastel gradient
 * from the Blobbi's base color.
 */
