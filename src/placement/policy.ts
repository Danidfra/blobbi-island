...
import type { AccessorySlot, BlobbiEffectSlot } from '@blobbi-kit/renderer';
import { EFFECT_SLOT_ORDER, REAR_VIEW_HIDDEN_SLOTS } from '@blobbi-kit/renderer';
 ...
 * order. Derived from `@blobbi-kit/renderer` rather than restated, so the placement
