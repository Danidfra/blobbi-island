...
export function FoodShopModal({ isOpen, onClose }: FoodShopModalProps) {
  ...
  return (
    <div
      ...
      data-block-move
    >
      <div className="w-[95%] h-full max-w-lg blobbi-card-xl border-4 border-island-wood/30 rounded-lg shadow-lg theme-transition flex flex-col max-h-[75vh] sm:max-h-[90vh]"
        role="dialog"
        aria-modal="true"
        data-block-move
