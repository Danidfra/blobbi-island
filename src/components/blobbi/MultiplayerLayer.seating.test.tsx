...
/* Only the COMPONENT is stubbed. The rest of `@blobbi-kit/renderer` is pure data
...
vi.mock('@blobbi-kit/renderer', async (importOriginal) => ({
  ...(await importOriginal<typeof import('@blobbi-kit/renderer')>()),
