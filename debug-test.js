...
console.log('Testing stage-open.png configuration:');
...
const zIndex = calculateBlobbiZIndex(95, 'stage-open.png');
console.log('Calculated z-index:', zIndex);

console.log('\nTesting all thresholds:');
console.log('Position 95% from top (5% from bottom):', calculateBlobbiZIndex(95, 'stage-open.png'));
console.log('Position 92% from top (8% from bottom):', calculateBlobbiZIndex(92, 'stage-open.png'));
console.log('Position 85% from top (15% from bottom):', calculateBlobbiZIndex(85, 'stage-open.png'));